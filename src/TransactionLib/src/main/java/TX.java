...
public class TX {
    ...
    public static ThreadLocal<LocalStorage> lStorage = ThreadLocal.withInitial(LocalStorage::new);//TODO:change back to protected
    ...
    public static boolean TXend() throws TXLibExceptions.AbortException {
        ...
        for (Entry<PriorityQueue, LocalPriorityQueue> entry : pqMap.entrySet()) {
            ...
            if (lPQueue.isLockedByMe) {
                ...
                lPQueue.clearInternalState();//TODO: check if necessary
            }
        }
